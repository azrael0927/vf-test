    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header bg-primary">
          <h5 class="modal-title text-white" id="exampleModalLabel">新增產品</h5>
          <button
            type="button"
            class="btn-close"
            ...
            <div class="col-sm-8">
              ...
              <div class="row gx-2">
                <div class="mb-3 col-md-6">
                  <label for="category" class="form-label d-block">分類
                    <input
                    type="text"
                    class="form-control"
                    id="category"
                ...
                <div class="mb-3 col-md-6">
                  <label for="unit" class="form-label d-block">單位
                    <input
                    type="text"
                    class="form-control"
                    id="unit"
              ...
              <div class="row gx-2">
                <div class="mb-3 col-md-6">
                  <label for="origin_price" class="form-label d-block">原價
                    <input
                    type="number"
                    class="form-control"
                    id="origin_price"
                ...
                <div class="mb-3 col-md-6">
                  <label for="price" class="form-label d-block">售價
                    <input
                    type="number"
                    class="form-control"
                    id="price"
